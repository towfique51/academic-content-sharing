...
@section('header')
    @parent
    <!-- Primary Meta Tags -->
    <title>Note Lagbe - {!! !empty($course) ? " -".$course->course_code : '' !!} - Labs</title>
    <meta name="title" content="Note Lagbe - {!! !empty($course) ? " -".$course->course_code : '' !!} - Labs">
    ...
    <meta property="og:title" content="Note Lagbe - {!! !empty($course) ? " -".$course->course_code : '' !!} - Labs">
    ...
    <meta property="twitter:title" content="Note Lagbe - {!! !empty($course) ? " -".$course->course_code : '' !!} - Labs">
